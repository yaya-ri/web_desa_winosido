                    ...
                    <div id="sidebar-scroll">
                        ...
                        <div class="sidebar-content">
                            ...
                            <ul class="sidebar-nav">
                                ...
                                <li>
                                    <a href="#" class="sidebar-nav-menu"><i class="fa fa-chevron-left sidebar-nav-indicator sidebar-nav-mini-hide"></i><i class="fa fa-home sidebar-nav-icon"></i><span class="sidebar-nav-mini-hide">Home</span></a>
                                    <ul>
                                        <li>
                                            <a href="<?php echo base_url(); ?>index.php/a_slider_c/">Slider</a>
                                        </li>
                                        <li>
                                            <a href="<?php echo base_url(); ?>index.php/a_edukasi_table_c/">Coretan Edukasi</a>
                                        </li>
                                        <li>
                                            <a href="kedungwungu.php">Dokumentasi</a>
                                        </li>
                                        <li>
                                            <a href="jurangcelong.php">Team</a>
                                        </li>
                                    </ul>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a href="<?php echo base_url(); ?>index.php/a_wisata_table_c/"><i class="gi gi-inbox sidebar-nav-icon"></i><span class="sidebar-nav-mini-hide">Objek Wisata</span></a>
                                </li>
                                <li>
                                    <a href="<?php echo base_url(); ?>index.php/a_produk_table_c/"><i class="fa fa-share-alt sidebar-nav-icon"></i><span class="sidebar-nav-mini-hide">Produk Lokal</span></a>
                                </li>
                                <li>
                                    <a href="<?php echo base_url(); ?>index.php/a_kebudayaan_table_c/"><i class="gi gi-picture sidebar-nav-icon"></i><span class="sidebar-nav-mini-hide">Kebudayaan</span></a>
                                </li>
                            </ul>
