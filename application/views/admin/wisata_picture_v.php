            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <form class="form-horizontal" method="POST" role="form" enctype="multipart/form-data" action="<?php echo base_url('index.php/a_wisata_picture_c/do_upload'); ?>" >
                                          ...
                                          <label for="select" class="col-lg-2 control-label">Foto / Gambar</label>
                                            <div class="col-lg-10">
                                                <select class="form-control" id="gambar" name="gambar">
                                                  ...
                                                  <option>Foto 6</option>
                                                  <option>Foto 7</option>
                                                  <option>Foto 8</option>
                                                  <option>Foto 9</option>
                                                </select>
                                            </div>    
                                        </div>
                                    </div> 
